...
class Evaluateur(models.Model):
    ...
    artcl_a_corrige = models.ManyToManyField('Article',null=True, blank=True)
...
class Conferance(models.Model):
    ...
    Commite = models.ForeignKey(Commite,null=True, 
...
# ++++++++++++++++  kol artcile 3ndeh liste des evluter corrige au moin  2 +++ 
    #reviwer_list = models.ManyToManyField(Evaluateur)
